...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, SecurityContextRepository securityContextRepository) throws Exception {
        http
            ...
            // Ancorado no UsernamePasswordAuthenticationFilter porque o addFilterBefore so
            // aceita como referencia um filtro que o Spring Security conheca -- filtro
            // proprio nao tem ordem registrada.
